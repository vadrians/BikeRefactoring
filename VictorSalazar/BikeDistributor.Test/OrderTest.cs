...
namespace BikeDistributor.Test
{
    ...
    public class OrderTest
    {
        ...
        public void ReceiptOneDefy()
        {
            ...
            Assert.AreEqual(ResultStatementOneDefy, order.GetReceipt());
        }
...
Total: $1,072.50";
        ...
        public void ReceiptOneElite()
        {
            ...
            Assert.AreEqual(ResultStatementOneElite, order.GetReceipt());
        }
...
Total: $2,145.00";
        ...
        public void ReceiptOneDuraAce()
        {
            ...
            Assert.AreEqual(ResultStatementOneDuraAce, order.GetReceipt());
        }
